...
class CartItem(models.Model):
    ...
    line_item_total = models.DecimalField(max_digits=6, decimal_places=2,default=25.55)
...
def cart_item_pre_save_receiver(sender, instance, *args, **kwargs):# purpose?? presave & post save
