...
class ImageFileDirectory_v2(collections.MutableMapping):
    ...
    def save(self, fp):
        ...
        # always write tags in ascending orders
        ...
        if STRIPOFFSETS in self.tag_v2:
            ...
            if READ_LIBTIFF or self._compression in ["tiff_ccitt", "group3",
                ...
                if fillorder == 2:
                    ...
                    # fillorder=1 mode
                    self.mode, rawmode = OPEN_INFO[key]
                # libtiff always returns the bytes in native orders.
                # we're expecting image byte orders. So, if the rawmode
...
# explicit big endian byte-orders
...
def _save(im, fp, filename):
    ...
    if libtiff:
        ...
        # libtiff always expects the bytes in native orders.
        # we're storing image byte orders. So, if the rawmode
        # contains I;16, we need to convert from native to image
        # byte orders.
    ...
    if "_debug_multipage" in im.encoderinfo:
        # just to access o32 and o16 (using correct byte orders)
